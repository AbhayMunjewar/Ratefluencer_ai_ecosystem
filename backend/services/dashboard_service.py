...
class DashboardService:
    ...
    def get_dashboard_data(self) -> Dict[str, Any]:
        ...
        platform_split = [
            { "name": "Instagram", "value": round((ig_count / total) * 100, 1) if total > 0 else 38.0 },
            { "name": "TikTok", "value": round((tt_count / total) * 100, 1) if total > 0 else 31.0 },
            { "name": "YouTube", "value": round((yt_count / total) * 100, 1) if total > 0 else 21.0 },
        ]
